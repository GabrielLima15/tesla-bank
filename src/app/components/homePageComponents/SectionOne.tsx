    ...
    <>
      <main className="min-h-screen">
        <div className="container mx-auto flex w-[80%] justify-between">
          <main ref={containerRef} className="flex flex-col items-start gap-4">
            ...
            <span className="font-inter text-[1.5rem] font-medium leading-[2.55rem] text-[#1A191E]">
              Com TeslaBank, você pode realizar transferências <br /> bancárias
              com zero taxa e pagar suas contas.
            </span>
